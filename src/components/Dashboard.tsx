    ...
    <>
      ...
      >
        ...
        <div className="flex-1 p-4 flex flex-col gap-5">
          ...
          {/* Impact summary — appears after simulation starts */}
          {(isSimulating || isComplete) && (
            <div>
                ...
                {AGENTS.map((agent, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Connector line to next (not last) */}
                    </div>
                  );
                })}
              </div>

              {/* Collapsed agent detail cards */}
              <div className="mt-2 space-y-1">
                {AGENTS.map((agent) =>
                  agentOutputs[agent] ? (
                    <AgentStatusCard
          ...
          {deployments.length > 0 && (
            <div>
              <Label>RESPONSE DEPLOYMENTS</Label>
              <div className="mt-2 space-y-1">
